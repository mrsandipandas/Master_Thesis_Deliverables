...
\begin{figure}[H] %h
	...
	\caption{\gls{te} to \gls{tm} mode conversion from top perspective}
	\label{fig:3_te_tm}
\end{figure}
...
\begin{figure}[H] %h
	...
	\caption{\gls{tm} to \gls{te} mode conversion from top perspective}
	\label{fig:3_tm_te}
\end{figure}
