...
\begin{itemize}	
	...
	\item[$\square$] Demonstration of the \gls{mems} based \gls{tpr} with an extinction ratio of more than \todo{Correct PER} \SI{10}{\decibel} for the two fundamental modes, in C and L bands.
\end{itemize}
